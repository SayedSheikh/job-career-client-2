...
import loginLottie from "../../src/Lotties/signup.json";
...
const SignUp = () => {
  ...
  return (
    <div className="hero-content flex-col lg:flex-row-reverse items-center mt-20 gap-0 justify-center  mx-auto">
